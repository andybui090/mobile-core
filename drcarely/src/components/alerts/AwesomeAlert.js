  ...
  _renderButton = data => {
    ...
    return (
      <TouchableOpacity
        ...
        testID={testID}
        onPress={onPress}>
        <Text style={[styles.buttonText, buttonTextStyle]} allowFontScaling={false}>{text}</Text>
      </TouchableOpacity>
    );
  };
      ...
      <View style={[styles.container, alertContainerStyle]}>
        ...
        <Animated.View
          ...
          <View style={[styles.content, contentStyle]}>
            ...
            {message ? (
              <Text style={[styles.message, messageStyle]} allowFontScaling={false}>{message}</Text>
            ) : null}
            {customView}
          </View>
