...
const CHeader = props => {
  ...
  const renderLeftIconComp = () =>
    !leftComponentDisable &&
    (leftComponent || (
      <TouchableOpacity hitSlop={hitSlops} onPress={leftComponentOnPress} style={styles.leftComponentStyle}>
        {btnClose ? (
  ...
  const renderRightIconComp = () =>
    ...
    (rightComponent || (
      <TouchableOpacity
        ...
        <IconX name={'menu'} origin={ICON_TYPE.ICONICONS} color={colors.white} size={26} />
      </TouchableOpacity>
    ));
  ...
  return (
    <View style={{ paddingTop: insets.top }}>
      <View style={[_container(height, width, backgroundColor, isBorderBottom), containerStyle]}>
