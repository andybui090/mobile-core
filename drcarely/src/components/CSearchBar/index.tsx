...
const CSearchBar = (props: appSearchBarProps, ref: searchBarRef | any) => {
  const { placeholder, onSubmitEditing, onClear, onFocus, content, onScan, searchIcon, disabled = false, ...args } = props;
  ...
  return (
    <SearchBar
      ...
      searchIcon={searchIcon ? searchIcon : <Icon name="search1" type="antdesign" size={20} color={colors.c98A2B3} />}
      {...args}
...
export default forwardRef(CSearchBar);