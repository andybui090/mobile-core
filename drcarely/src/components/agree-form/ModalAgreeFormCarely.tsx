...
export const ModalAgreeFormCarely: React.FC<Props> = ({
  visible,
  onClose,
  msg,
  title = '',
      ...
      <Pressable style={styles.overlay} onPress={onClose}>
        <Pressable style={styles.container}>
          {!title ? (
            ...
            <Row center>
              <CText h4 w600 color={'#101828'} style={{marginLeft: 5}}>
                {title}
              </CText>
            </Row>
          )}
...
const styles = StyleSheet.create({
  ...
  button: {
    ...
    paddingVertical: 12,
    borderRadius: 8,
    backgroundColor: '#19A2A7', // đổi sang màu primary của app nếu cần
    justifyContent: 'center',
    alignItems: 'center',
  },
});
